...
//echo $xml;
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='grid' class='table table-striped table-bordered table-condensed table-hover display compact nowrap' cellspacing='0' style='width:100%;'><tfoot><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tfoot></table></div>"; 
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'MES ACTUAL AÑO ANTERIOR', 'className': 'text-right', 'width': '75px', 'targets': 8},
                { 'title': 'MES ANTERIOR AÑO ANT', 'className': 'text-right', 'width': '75px', 'targets': 9}
            ],
