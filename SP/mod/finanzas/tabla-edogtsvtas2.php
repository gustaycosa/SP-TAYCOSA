...
try{ 
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='grid' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style='width:100%;' ><tfoot><tr><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot></table></div>";
   ...
   $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'COSTOS', 'className': 'text-right', width: '75px', 'targets': 7},
                { 'title': 'UTIL/PER GEN', 'className': 'text-right', width: '75px', 'targets': 8},
                { 'title': 'AÑO ACTUAL', 'className': 'text-right', width: '75px', 'targets': 9},
                { 'title': 'AÑO ANT', 'className': 'text-right', width: '75px', 'targets': 10}
            ],
      ...
      "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api_total.column( 10 ).footer() ).html(numFormat(total_total) );
