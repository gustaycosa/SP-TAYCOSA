...
//echo $xml;
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='griddet' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style='width:100%;' ><tfoot><th></th><th></th><th></th></tfoot></table></div>";
...
?>
    ...
    <script type="text/javascript"> 
       ...
       "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_total.column( 2 ).footer() ).html(numFormat(total_total) );
            ...
            // Update footer
            $( api_abono.column( 1 ).footer() ).html(numFormat(total_abono) );
