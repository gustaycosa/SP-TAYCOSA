...
*/
 $(document).ready(function() {
       ...
       "footerCallback": function ( row, data, start, end, display ) {
            ...
            // Update footer
            $( api_abono.column( 9 ).footer() ).html(numFormat(total_abono) );
            ...
            // Update footer
            $( api_vtas.column( 8 ).footer() ).html(numFormat(total_vtas) );
